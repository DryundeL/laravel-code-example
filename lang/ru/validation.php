...
return [
    ...
    'attributes' => [
        ...
        'education_duration' => 'Продолжительность обучения',
        'education_start_date' => 'Дата начала обучения',
        'education_end_date' => 'Дата окончания обучения',
    ],
];
